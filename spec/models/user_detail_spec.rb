require 'rails_helper'
  ...
  describe UserDetail do
    describe '#create' do
      ...
      it "invalid without family_name" do
        user_detail = build(:user_detail, family_name: nil)
        user_detail.valid?
        expect(user_detail.errors[:family_name]).to include("を入力してください")
      end
      ...
      it "invalid without kana_family_name" do
        user_detail = build(:user_detail, kana_family_name: nil)
        user_detail.valid?
        expect(user_detail.errors[:kana_family_name]).to include("を入力してください")
      end
      ...
      it "invalid without kana_first_name" do
        user_detail = build(:user_detail, kana_first_name: nil)
        user_detail.valid?
        expect(user_detail.errors[:kana_first_name]).to include("を入力してください")
      end
      ...
      it "invalid without address" do
        ...
        it "invalid without phone_number" do
          ...
          user_detail.valid?
          expect(user_detail.errors[:phone_number]).to include("を入力してください")
        end

        it "invalid when phone_number include strings" do
          user_detail = build(:user_detail, phone_number: "090-1234-5678")
          user_detail.valid?
          expect(user_detail.errors[:phone_number]).to include("は不正な値です")
        end

        it "invalid when phone_number lengths are under 10" do
          user_detail = build(:user_detail, phone_number: "123456789")
          user_detail.valid?
          expect(user_detail.errors[:phone_number]).to include("は不正な値です")
        end

        it "invalid when phone_number lengths are over 11" do
        ...
        it "invalid without postal_code" do
          user_detail = build(:user_detail, postal_code: nil)
          user_detail.valid?
          expect(user_detail.errors[:postal_code]).to include("を入力してください")
        end

        it "invalid when postal_code include strings" do
          user_detail = build(:user_detail, postal_code: "123-4567")
          user_detail.valid?
          expect(user_detail.errors[:postal_code]).to include("は不正な値です")
        end

        it "invalid when postal_code lengths are under 6" do
          user_detail = build(:user_detail, postal_code: "123456")
          user_detail.valid?
          expect(user_detail.errors[:postal_code]).to include("は不正な値です")
        end

        it "invalid when postal_code lengths are over 8" do
        ...
        it "invalid when profile lengths are over 100" do
          ...
          user_detail.valid?
          expect(user_detail.errors[:profile][0]).to include("文字以内で入力してください")
        end
